...
class HrProbation(models.TransientModel):
    _name = "ora.probation.wizard"
    _description = "HR Probation wizard"
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('de_employee_reports.hr_probation_report_xlx').report_action(self, data=data, config=False)