...
#         domain = []
        ...
        domain += ['|','|',('employee_id.user_id', '=', http.request.env.context.get('uid')),('employee_id.parent_id.user_id', '=', http.request.env.context.get('uid')),('manager_id.user_id', '=', http.request.env.context.get('uid'))]    
    ...
    def portal_appraisal_objective(self, appraisal_id, access_token=None, **kw):
        ...
        id = appraisal_id
        try:
            appraisal_sudo = request.env['hr.appraisal.objective'].sudo().search([('id','=',appraisal_id)])
        except (AccessError, MissingError):
            return request.redirect('/my')        
    ...
    def edit_portal_appraisal_objective(self, appraisal_id, access_token=None, **kw):
        ...
        id = appraisal_id
        try:
            appraisal_sudo = self.env['hr.appraisal.objective'].sudo().search([('id','=',appraisal_id)])
        except (AccessError, MissingError):
            return request.redirect('/my')        
